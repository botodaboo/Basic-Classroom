...
(1, 'CTDL - Đã sửa', 'C404', 'Cau truc du lieu', 'khanhduynguyen170900@gmail.com', 'LOGO-G.png'),
...
(1, 'Danh sách cấm thi do vắng quá số buổi học theo quy định (vắng từ 3 buổi trở lên). Hiện tại Nhóm 1 Tổ 2 vẫn còn một buổi học nữa nên danh sách có thể còn cập nhật thêm. Các em xem danh sách cấm thi và phản hồi cho thầy đến hết 27/11.', 1),
(5, 'Hôm nay là thứ bảy, anh đi vào bar!', 2),
